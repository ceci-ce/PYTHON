...
while opcion != "fin":
    lista_peliculas.append(opcion) #Agrega (append) la película que el usuario ha escrito a la lista
...
print(f"Número total de películas sin repetir: {set(lista_peliculas)}") #set() convierte la lista en un conjunto, que elimina los duplicados