...
# Escribe un script que reciba como argumentos el nombre de un directorio y una extensión de archivo (por ejemplo, .txt),
# y elimine todos los archivos con esa extensión en el directorio.
